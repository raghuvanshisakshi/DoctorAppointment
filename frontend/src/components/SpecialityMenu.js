...
const SpecialityMenu = () => {
  return (
    <div className = 'flex flex-col items-center gap-4 py-16 text-gray-800' id = 'speciality'>
      ...
      <p className = 'sm:w-1/3 text-center text-sm'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, magni? Eius nesciunt earum mollitia, blanditiis delectus aperiam alias aspernatur incidunt.</p>
